        ...
        <div className="lg:col-span-2 grid gap-8">
          <Card title="Public entry point">
            ...
            <p className="text-sm opacity-80 mt-3">
              90-minute one-on-one consultation. This is the starting point for all clients. If you enroll in a preparation package, $150 of this fee will be applied toward the package total.
            </p>
          </Card>
