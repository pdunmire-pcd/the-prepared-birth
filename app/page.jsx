      ...
      <section className="container-page py-16 md:py-24 grid md:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <p className="mt-5 text-lg md:text-xl opacity-90 max-w-xl">
            Individualized, quiet, experienced birth guidance for families preparing for hospital or birth-center care in the Puget Sound region. Thoughtful birth education and consultation - feel settled, informed, and confident - clarity during pregnancy. Support without adding another person at your birth.
          </p>
